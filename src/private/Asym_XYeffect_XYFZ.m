...
function [cycle_count_sub, SRAM_Access_sub, DRAM_Access_sub] = Asym_XYeffect_XYFZ (Layer_param, Hardware_param, Tech_param)
...
%Calling the X->Y->F->Z branch to perform computation with new_Nos_of_filter
...
if (done_flag == 0) && (ofmap_height_effective < ofmap_height)
    ...
    [XY_effective, cycle_count, SRAM_Access, DRAM_Access] = XtoYtoFtoZ(Layer_param, Hardware_param, Tech_param);
